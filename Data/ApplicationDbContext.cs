    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Class>().HasData(
                new Class { ClassId = 1, ClassName = "C#.Net" },
                new Class { ClassId = 2, ClassName = "ASP.NET Using C#" },
                new Class { ClassId = 3, ClassName = "Java" },
                new Class { ClassId = 4, ClassName = "JavaScript & jQuery" },
                new Class { ClassId = 5, ClassName = "Data Analysis With Python" }
                );
            ...
            builder.Entity<Book>().HasData(
                new Book
                {
                    ...
                    BookCover = "images/MurachCSharpBook.jpg",
                ...
                new Book
                {
                    ...
                    BookStatus = "Not Started",
                    BookCover = "images/MurachASPNetBook.jpg",
                ...
                new Book
                {
                    ...
                    BookStatus = "Not Started",
                    BookCover = "images/MurachJavaBook.jpg",
                ...
                new Book
                {
                    ...
                    BookStatus = "Not Started",
                    BookCover = "images/MurachJavaScriptBook.jpg",
                ...
                new Book
                {
                    ...
                    BookStatus = "Not Started",
                    BookCover = "images/MurachPythonBook.jpg",
